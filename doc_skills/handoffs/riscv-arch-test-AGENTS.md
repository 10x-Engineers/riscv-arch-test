...
- Agentic lifecycle (spec → norms → reuse → generator → `make testgen` → validate → coverpoints): project skill **`act4-testgen`** (`.cursor/skills/act4-testgen/`). Do not hand-edit generated `.S`.
